...
public class Demo extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
    ...
    public static void main(String[] args) {
     ...
     //   demo.privateMsg(0, 10001, 2234567819L, "xem", 0);
...
//        // 模拟群聊消息
//        // 开始模拟群聊消息
        demo.groupMsg(0, 10006, 3456789012L, 3333333334L, "", "xem", 0);
...
//        demo.groupMsg(0, 10011, 427984429L, 11111111114L, "", "qwq 有没有一起开的\n[CQ:at,qq=3333333334]你玩嘛", 0);
    ...
    public int privateMsg(int subType, int msgId, long fromQQ, String msg, int font) {
        // 这里处理消息
    	if("xem".equals(msg.toLowerCase().trim())){
 ...
 public String response(){
	 String result = "";
	 try {
     	//JSONObject dataJson = new JSONObject(sendGet("http://202.5.16.95:8080/WebDataSave3.0/api?token=sdalskf6455156"));
     	//JSONObject dataJson = new JSONObject(sendGet("http://172.82.166.131:8080/WebDataSave3.0/api?token=sdalskf6455156"));
     	JSONObject dataJson = new JSONObject(sendGet("http://69.30.222.139:6790/WebDataSave3.0/api?token=sdalskf6455156"));
			System.out.println(dataJson);
			
			String message_CNY = dataJson.getString("message_CNY");
			long BTC_price_CNY = dataJson.getInt("BTC_price_CNY");
			String message_BTC = dataJson.getString("message_BTC");
			String Hit_price = dataJson.getString("Hit_price");
			String Hit_price_BTC_CNY = dataJson.getString("Hit_price_BTC_CNY");
			String Binance_price = dataJson.getString("Binance_price");
			String Binance_price_BTC_CNY = dataJson.getString("Binance_price_BTC_CNY");
//			String Poloniex_price = dataJson.getString("Poloniex_price");
//			String Poloniex_price_BTC_CNY = dataJson.getString("Poloniex_price_BTC_CNY");
			String Zaif_price = dataJson.getString("Zaif_price");
			String Zaif_price_BTC_CNY = dataJson.getString("Zaif_price_BTC_CNY");
			
			result = message_CNY + "( btc:" + BTC_price_CNY + " )" + message_BTC + "\r\n"  
					+ "【HitBtc】" + Hit_price + "(" + Hit_price_BTC_CNY + ")\r\n"
					+ "【Binance】" + Binance_price + "(" + Binance_price_BTC_CNY + ")\r\n"
//					+ "【Poloniex】" + Poloniex_price + "(" + Poloniex_price_BTC_CNY + ")\r\n" 
					+ "【Zaif】" + Zaif_price
					+ "(" + Zaif_price_BTC_CNY + ")";
		} catch (Exception e) {
